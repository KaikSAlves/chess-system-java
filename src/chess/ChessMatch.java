...
public class ChessMatch {
	...
	private ChessPiece enPassantVunerble;
	...
	public ChessPiece getEnPassantVunerble() {
		return enPassantVunerble;
	}
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		if (movedPiece instanceof Pawn && (target.getRow() == source.getRow() - 2)
			...
			enPassantVunerble = movedPiece;
		} else {
			enPassantVunerble = null;
		}
	...
	private void undoMove(Position source, Position target, Piece capturedPiece) {
		...
		// # special move = en passant
		if (p instanceof Pawn) {
			if (source.getColumn() != target.getColumn() && capturedPiece == enPassantVunerble) {
